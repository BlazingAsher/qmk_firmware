#ifdef ENABLE_RGB_MATRIX_GLORIOUS_PASTEL_SOLID
RGB_MATRIX_EFFECT(GLORIOUS_PASTEL_SOLID)
#ifdef RGB_MATRIX_CUSTOM_EFFECT_IMPLS

#include "custom/david_libs.h"

bool GLORIOUS_PASTEL_SOLID(effect_params_t* params) {
    ...
    blue_base.v = config_hsv.v;
    green_base.v = config_hsv.v;
    pink_base.v = config_hsv.v;
...
#endif //ENABLE_RGB_MATRIX_GLORIOUS_PASTEL_SOLID
